...
<div class="absolute top-full left-0 -translate-y-full w-full px-5 py-8 rounded-b-3xl pt-10 flex flex-row gap-2 bg-gradient-to-t from-[rgba(85,85,85,0.7)] from-60% to-[rgba(231,231,231,0]">
    ...
    <form use:enhance bind:this={formElement} method="post" enctype="multipart/form-data" class="hidden">
